        ...
        <>
            <div className="lg:ml-64 flex justify-center items-center min-h-screen">
                <form action={handleSubmit} className='flex flex-col gap-4 w-100 p-4  shadow-[0_0_5px_gray] rounded-lg'>
                    ...
                    <button type="submit" className='mt-6 bg-blue-700 w-full cursor-pointer p-2 rounded-md hover:bg-blue-800 text-white text-xl active:bg-blue-900 font-semibold'>Add</button>
                </form>
            </div>
            <ToastContainer />
